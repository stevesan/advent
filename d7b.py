...
space_used = root.totalsize
free_space_size = disk_size - space_used
min_to_freeup = size_needed - free_space_size
assert min_to_freeup > 0

def collect_sizes(dirr:Dir, sizes:list[int]):
  if dirr.totalsize >= min_to_freeup:
